...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 90, 2, 1486);
    		},
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { type: 0, href: 1, mode: 2, color: 3 });
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 47, 4, 862);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 45, 4, 796);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*controlType*/ ctx[1] === "textarea") return create_if_block$1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$1, 43, 2, 725);
    			attr_dev(div, "class", "form-control svelte-xzzzlr");
    			add_location(div, file$1, 42, 0, 696);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { rows = null } = $$props;
    	let { type = "text" } = $$props;
    	const writable_props = ["value", "controlType", "id", "label", "rows", "type"];
    	...
    	return [value, controlType, id, label, rows, type, input_handler, input_handler_1];
    }
    ...
    // (75:4) <Button type="button" mode="outline" on:click={cancel}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(75:4) <Button type=\\\"button\\\" mode=\\\"outline\\\" on:click={cancel}>",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 73, 2, 1646);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (39:0) <Modal title="Edit Meetup" on:cancel>
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$3, 39, 2, 711);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:0) <Modal title=\\\"Edit Meetup\\\" on:cancel>",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, description, address, imageUrl, subtitle, title*/ 65567) {
